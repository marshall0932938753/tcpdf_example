...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // 公司與報表名稱
        $title = '
<h4 style="font-size: 20pt; font-weight: normal; text-align: center;">598搬家網搬家明細</h4>

<table>
    <tr>
        <td style="width: 30%;"></td>
        <td style="border-bottom: 2px solid black; font-size: 20pt; font-weight: normal; text-align: center; width: 40%;">訂單明細</td>
        <td style="width: 30%;"></td>
    </tr>
    <tr>
        <td colspan="3"></td>
...
<table cellpadding="1">
    <tr>
        ...
        <td style="border-bottom: 1px solid black; width: 460px;">項目</td>
...
// EOD;
    ...
    $html .= '
        <tr>
            <td style="line-height: 1.5; width: 10px;"></td>
            <td style="text-align: left; width: 460px;">巨力公司搬家服務</td>
            <td style="text-align: left; width: auto;">200000000000元</td>
        </tr>';
